...
export function SocialAuth() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      clientLogger.error('Failed to sign in with Google', error);
  ...
  return (
    <div className="flex flex-col space-y-4">
      <Button
        ...
        className="hover:bg-muted/50 relative w-full overflow-hidden transition-all duration-300 hover:shadow-md"
      >
        {isLoading ? (
